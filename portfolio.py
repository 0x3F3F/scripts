...
def	SetupShareDictionaries(currDict, shareDictMultiAss, shareDictGrowth, shareDictIndexes, pmDict, shareDictWatchlist):
	...
	#shareDictGrowth['TDW']     =  ['TDW',	'Tidewater',						'USD',		2,		105,				NO_TARGET_PRICE]
	...
	shareDictGrowth['SPDM.L']  =  ['SPDM',	'Platinum',							'GBX',		0,		6290,			NO_TARGET_PRICE]
	...
	shareDictWatchlist['CKN.L']   =  ['CKN',	'Clarksons',						'GBX',		0,		4675,			NO_TARGET_PRICE ]
