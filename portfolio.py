...
def	SetupShareDictionaries(currDict, shareDictMultiAss, shareDictGrowth, shareDictIndexes, pmDict, shareDictWatchlist):
	...
	pmDict['PL=F'] =			['Platinum',	'Platinum',						'USD',		0,		1725,			NO_TARGET_PRICE]
	...
	shareDictGrowth['RCO.PA']  =  ['RCO',	'Remy',								'EUR',		1,		210,			NO_TARGET_PRICE ]
	...
	shareDictGrowth['CME']     =  ['CME',	'Intercontenental Exchange',		'USD',		2,		326,			NO_TARGET_PRICE]
	shareDictGrowth['ICE']     =  ['ICE',	'Intercontenental Exchange',		'USD',		2,		186.4,			NO_TARGET_PRICE]
	...
	shareDictGrowth['MOS']		=  ['MOS',	'Mosaic',					'USD',		2,		75,			NO_TARGET_PRICE]
	shareDictGrowth['TGA.L']   =  ['TGA',	'TGA',								'GBP',		0,		1900,			NO_TARGET_PRICE]
	shareDictGrowth['CNR']		=  ['CNR',	'Core Natural Res',					'USD',		2,		131,			NO_TARGET_PRICE]
	shareDictGrowth['BTU']    =  ['BTU',	'Peabody',							'USD',		2,		41.14,			NO_TARGET_PRICE]
	shareDictGrowth['WHC.AX']  =  ['WHC',	'WHC',								'AUD',		2,		10.52,			NO_TARGET_PRICE]
	shareDictGrowth['NHC.AX']  =  ['NHC',	'New Hope',							'AUD',		2,		7.35,			NO_TARGET_PRICE]
	shareDictGrowth['SMR.AX']  =  ['SMR',	'Stanmore',							'AUD',		2,		4.15,			NO_TARGET_PRICE]
	shareDictGrowth['YAL.AX']  =  ['YAL',	'Yancaol',							'AUD',		2,		7.32,			NO_TARGET_PRICE]
	shareDictGrowth['AMR']    =  ['AMR',	'AMR',								'USD',		2,		439,			NO_TARGET_PRICE]
	...
	shareDictWatchlist['0388.HK']  =  ['0388',	'Hong Kong Exchanges',				'HKD',		1,		532,			NO_TARGET_PRICE ]
...
def GetAndPrintSharePrices(shareDict, inputIndexName):
	...
	for k, v in shareDict.items():
		...
		#print("Version "+YahooFinance.__version__, end='')
